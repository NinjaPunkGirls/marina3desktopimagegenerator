...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const ENGINE_ID = "stable-diffusion-xl-1024-v1-0"; // Changed engine_id
            ...
            try {
                const response = await fetch(API_ENDPOINT, {
                    ...
                    body: JSON.stringify({
                        ...
                        cfg_scale: 7,
                        height: 1024, // Updated to a valid dimension for SDXL 1.0
                        width: 1024,  // Updated to a valid dimension for SDXL 1.0
                        samples: 1,
