...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Corrected official Stability AI Platform API endpoint structure
    const API_BASE_URL = "https://api.stability.ai/v1/generation";
    const ENGINE_ID = "stable-diffusion-v1-5"; // Example engine_id, can be changed (e.g., "stable-diffusion-xl-1024-v1-0")
        ...
        if (prompt) {
            ...
            try {
                const response = await fetch(API_ENDPOINT, {
                    ...
                    body: JSON.stringify({
                        text_prompts: [{ text: prompt }], // Correct parameter name and structure
                        cfg_scale: 7,
                        height: 512,
                        width: 512,
                        samples: 1,
                        ...
                        // See https://stability.ai/docs/API-Reference#tag/Generation
                    }),
                });
